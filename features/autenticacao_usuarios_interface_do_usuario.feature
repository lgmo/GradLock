Feature: Autenticação de Usuários - Interface do Usuário
  ...
  Scenario: Login bem-sucedido com CPF e senha válidos
    ...
    And ela possui cadastro com CPF "34567890123" e senha "041102"
    ...
    And deve visualizar a mensagem "Login realizado com sucesso!"
  ...
  Scenario: Login mal-sucedido por CPF inexistente
    ...
    And não há um usuário cadastrado com o cpf "45678901234"
  ...
  Scenario: Login mal-sucedido por senha incorreta
    ...
    And possui cadastro com CPF "56789012345" e senha correta
  ...
  Scenario: Login mal-sucedido por ausência de campos obrigatórios
    ...
    And clica no botão "Entrar"
    Then deve ser exibida a mensagem "Preencha todos os campos!"
